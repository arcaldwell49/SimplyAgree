context("tolerance_delta_gls")

# Test that the function returns a tolerance_delta class
test_that("tolerance_delta_gls returns a tolerance_delta class", {
  # generic
  expect_s3_class(tolerance_delta_gls(data = mtcars, x = "mpg", y = "disp"), "tolerance_delta")
