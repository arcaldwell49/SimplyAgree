...
If the `other_ci` argument is set to TRUE then nonparametric bootstrapped confidence intervals will be calculated for the CV, SEM, SEP, and SEE. The number of resamples can be set with the replicates argument (default is 499; increase for greater accuracy). The reported confidence intervals are estimated using the percentile method. 
