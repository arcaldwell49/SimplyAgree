...
$$
\begin{aligned}
ICC(1,1) = \frac{MSB - MSW}{MSB + (n_j-1) \cdot MSW} \\
ICC(2,1) = \frac{MSB - MSE}{MSB+(n_j -1) \cdot MSE + n_j \cdot (MSJ - MSE) \cdot n^{-1}} \\
ICC(3,1) = \frac{MSB - MSE}{MSB + (n_j -1) \cdot MSE}
\\
\\
ICC(1,k) = \frac{MSB - MSW}{MSB}
\\
ICC(2,k) = \frac{MSB - MSW}{MSB + (MSJ - MSE) \cdot n_j^{-1}}
\\
ICC(3,k) = \frac{MSB - MSE}{MSB}
\end{aligned}
$$
